    ...
    public partial class criacaoDB : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    HistoriocoRecursoId = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Valor = table.Column<decimal>(nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HistoricoRecursos", x => x.HistoriocoRecursoId);
                    table.ForeignKey(
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "ed4a186b-c153-4218-8251-930c40747f31", "fbebcaf4-2f82-4888-9fa8-79f77ac91606", "Morador do Prédio", "Morador", "MORADOR" },
                    { "0630975c-d713-427c-bc2b-e8a80a75b964", "5e2b0e00-7bec-4ff1-b482-3b61304e2ba6", "Síndico do Prédio", "Sindico", "SINDICO" },
                    { "eb56644c-a1b6-4013-8679-f496facffe1b", "59c6f494-89a3-49a0-851d-7fc98637e619", "Administrador do Prédio", "Administrador", "ADMINISTRADOR" }
                });
